			...
			for (size_t i = 0; i < mWidgets.size(); i++)
			{
				...
				else if (Widget.Type == 1) //Bar
				{
					...
					ImGui::GetWindowDrawList()->AddRectFilled(
						Widget.Position - ImVec2(1, 1),
						Widget.Position + Widget.Size + ImVec2(1, 1),
						ImGui::GetColorU32(ImVec4(0.0f, 0.0f, 0.0f, ImGui::GetStyle().Alpha * Widget.AlphaAnimation))
					);

					ImGui::GetWindowDrawList()->AddRectFilled(
						Widget.Position,
						Widget.Position + Widget.Size,
						ImGui::GetColorU32(ImVec4(80 / 255.f, 80 / 255.f, 80 / 255.f, ImGui::GetStyle().Alpha * (125.f / 255.f)))
					);
