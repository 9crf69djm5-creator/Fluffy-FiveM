...
class cColors {
public:
	ImVec4 Base = ImColor(75, 70, 175); //75, 70, 175 - 130, 151, 248
...
public:
	...
	int iCurrentPage = 6;
	float TabAdd = 0.f;
	bool IsLogged = false; // set true in main.cpp after console KeyAuth
